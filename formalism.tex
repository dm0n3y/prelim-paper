...
pattern \cite{zipper}, which decouples a focused substructure $B$
from its surrounding context $M$.
...
\end{array}
\]
Our zipper design diverges from prior art in our pursuit
...
arbitrary ranges of a serialization of the program.
Toward these ends, movement and selection in \ty~ rely
on a form of incremental unparsing and reparsing by which
hierarchical structures may be temporarily ``flattened''
