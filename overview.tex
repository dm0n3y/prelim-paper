...
\note{note explicitly the way our structure editor simplifies but still represents existing editors}

\note{introduce new terminology, concrete vs abstract is overloaded, instead use something like language vs editor syntax}

\note{make clear what's coming: naive vs our approach}

\note{cite Hazelnut, Scratch, MPS}
...
\begin{figure}
  ...
  \end{array}\]
  \caption{
    Language syntax of types $\styp$, patterns $\spat$, and expressions $\sexp$.
...
\subsection{A typical structure editor}
\note{
