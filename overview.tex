...
\note{talk about hole insertion for linear entry, talk about tips noting
that hole fixing is necessary on construction, then return to this idea
in restructuring}
...
\begin{align*}
  ...
  & \texttt{$\lambda$ n . n , n|* 2 + 1|, 1}
\end{align*}
\note{rewrite this so that I am invoking the option to
restructure rather than just delete.}
\note{make sure to emphasize the selection part}
