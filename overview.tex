...
alternatively, you could ``feed'' it by moving over to the
...
\note{discuss how restructuring extends normal clipboard
in its ability to carry multiple related selections,
and extends selection ability of other structure editors
in its ability to carry individual nodes and not be
restricted to entire trees}
