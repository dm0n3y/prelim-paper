\begin{figure}
  ...
  \begin{mathpar}
    ...
    \inferrule[]{
      ...
      \fixHolesSelections{\selection_1}{\selection_2}{s}{\selection'_1}{\selection'_2\soptile{\ophole}^s}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    ...
    \inferrule[]{
      ...
      \fixHolesSelection{\lltip{s}}{\selem\selection}{\soptile{\ophole}^s\selem\selection'}{\tip'}
    } \\
    \inferrule[]{
      \neg(\ishole{\selem}) \\
      ...
      \fixHolesSelection{\rrtip{s}}{\selem\selection}{\sbintile{\binhole}^s\selem\selection'}{\tip'}
    } \\
  \end{mathpar}
  \caption{
    Hole fixing
