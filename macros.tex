...
\newcommand{\pmove}[3]{#1 \xlongrightarrow{\actionlit{move}~#2}_{\scriptscriptstyle\texttt{point}} #3}
...
\newcommand{\zipper}[2]{#1~{\color{black!40!}\boldsymbol\gtrdot}~#2}
\newcommand{\subject}{B}
\newcommand{\zframe}{M}
