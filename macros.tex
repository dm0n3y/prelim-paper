...
\newlength{\tilelen}
\newcommand{\theight}{1.3ex}
\newcommand{\tiplen}{0.45ex}

\newcommand{\soptile}[1]{%
  \settowidth{\tilelen}{$#1$}%
  \vcenter{\hbox{%
  \begin{tikzpicture}%
    \draw[line width=0.75pt,black!40!]
      (0,-\theight)
      -- (-\tiplen,0)
      -- (0,\theight)
      -- (\tilelen,\theight)
      ...
      -- (\the\tilelen,-\theight)
      -- cycle;
    \node at ($ (\tilelen/2,0)$) {$#1$\vphantom{|}};
  \end{tikzpicture}%
  }}%
}
\newcommand{\spretile}[1]{%
  \settowidth{\tilelen}{$#1$}%
  \vcenter{\hbox{%
  \begin{tikzpicture}%
    \draw[line width=0.75pt,black!40!]
...
\newcommand{\holeheight}{0.45ex}
\newcommand{\holewidth}{0.25ex}
\newcommand{\holetip}{0.18ex}
...
\draw[line width=0.75pt,black!40!]
 ...
 \draw[line width=0.75pt,gray]
  ($ (\tilelen/2-\holewidth-\holetip,0) $)
  -- ($ (\tilelen/2-\holewidth,\holeheight) $)
  -- ($ (\tilelen/2+\holewidth,\holeheight) $)
  -- ($ (\tilelen/2+\holewidth+\holetip,0) $)
  -- ($ (\tilelen/2+\holewidth,-\holeheight) $)
  -- ($ (\tilelen/2-\holewidth,-\holeheight) $)
...
\draw[line width=0.75pt,black!40!]
  ...
  -- cycle;%
\draw[line width=0.65pt,gray]
  ($ (\tilelen/2-\holewidth,0) $)
  -- ($ (\tilelen/2-\holewidth-\holetip,\holeheight) $)
  -- ($ (\tilelen/2+\holewidth+\holetip,\holeheight) $)
  -- ($ (\tilelen/2+\holewidth,0) $)
  -- ($ (\tilelen/2+\holewidth+\holetip,-\holeheight) $)
  -- ($ (\tilelen/2-\holewidth-\holetip,-\holeheight) $)
...
% \newcommand{\optile}[1]{\mbox{$\ltiletip\overline{#1\vphantom{|}}\rtiletip$}}
% \newcommand{\pretile}[1]{\mbox{$\ltiletip\overline{#1\vphantom{|}}\ltiletip$}}
% \newcommand{\posttile}[1]{\mbox{$\rtiletip\overline{#1\vphantom{|}}\rtiletip$}}
% \newcommand{\bintile}[1]{\mbox{$\rtiletip\overline{#1\vphantom{|}}\ltiletip$}}
...
\newcommand{\tpmove}[1]{\xlongrightarrow{\actionlit{move}~#1}_{\scriptscriptstyle\texttt{point}}}
\newcommand{\pmove}[3]{#1 \tpmove{#2} #3}
\newcommand{\smove}[3]{#1 \xlongrightarrow{\actionlit{move}~#2}_{\scriptscriptstyle\texttt{select}} #3}
\newcommand{\rmove}[3]{#1 \xlongrightarrow{\actionlit{move}~#2}_{\scriptscriptstyle\texttt{restructure}} #3}

\newcommand{\tiles}{T}
\newcommand{\tile}{t}
\newcommand{\shard}{h}
\newcommand{\shardlit}[1]{\underline{\texttt{#1}}}
\newcommand{\selection}{C}
\newcommand{\selem}{c}
\newcommand{\tframe}{F}
\newcommand{\tfrelem}{f}
% \newcommand{\tframelit}[2]{#1 ~\gg~ #2}
\newcommand{\ttframelit}{{\color{black!35!}\boldsymbol\gg}}
% \newcommand{\tsframelit}{\rotatebox[origin=c]{90}{\textcolor{black!35!}{$\boldsymbol\ggg$}}}
\newcommand{\tsframelit}{{\color{black!35!}\boldsymbol\ggg}}
\newcommand{\tframelit}[2]{#1\ \ \ttframelit\ \ #2}
\newcommand{\sframelit}[2]{#1\ \ \tsframelit\ \ #2}
\newcommand{\framehole}{\textcolor{black!35!}{\bullet}}
\newcommand{\froot}{{\color{black!40!}\boldsymbol\top}}

\newcommand{\zip}{Z}
% \newcommand{\zipper}[2]{#1\ \rotatebox[origin=c]{90}{\textcolor{black!40!}{$\boldsymbol\gtrdot$}}\ #2}
\newcommand{\tzipper}{{\color{black!40!}\boldsymbol\gtrdot}}
\newcommand{\zipper}[2]{#1~\tzipper~#2}
\newcommand{\subject}{B}
\newcommand{\zframe}{M}
...
\newcommand{\selectingRight}[3]{#1\overline{#2}\hspace{-3pt}\multimapbothvert\hspace{-3pt}#3}
\newcommand{\restructuring}[3]{#1\hspace{-3pt}\multimapbothvert\hspace{-3pt}\widehat{#2}#3}

\newcommand{\erasezip}[1]{#1^{\Diamond}}
\newcommand{\erasesub}[1]{#1^{\Diamond}}
\newcommand{\fillFrame}[2]{#1\blacktriangleright#2}
...
\newcommand{\lltip}[1]{\langle^{#1}}
\newcommand{\rrtip}[1]{\rangle^{#1}}
\newcommand{\tip}{\tau}
...
\newcommand{\fixHolesSelections}[5]{#1\mid#2\rightsquigarrow_{#3}#4\mid#5}
