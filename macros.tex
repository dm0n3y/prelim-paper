...
\newcommand{\pmove}[3]{#1 \xlongrightarrow{\actionlit{pmove $#2$}} #3}
\newcommand{\smove}[3]{#1 \xlongrightarrow{\actionlit{smove $#2$}} #3}
\newcommand{\rmove}[3]{#1 \xlongrightarrow{\actionlit{rmove $#2$}} #3}

\newcommand{\tiles}{T}
\newcommand{\tile}{t}
\newcommand{\token}{k}
\newcommand{\tokenLit}[1]{\underline{#1}}
\newcommand{\selection}{L}
\newcommand{\selem}{\ell}
\newcommand{\tframe}{F}
\newcommand{\tfrelem}{f}
