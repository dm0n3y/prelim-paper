\begin{figure*}
  ...
  \inferrule[ConstructTile]{
    ...
    \fixHolesSelections{\rtipconc{s}}{\selection_1\selem}{\selection_3\selection_2}{\ltipconc{s}}{\selection_4}{\selection_5}
  }{
    \performAction{
  ...
  \inferrule[MoveRightRestructuringWhole]{
    ...
    \performAction{
      ...
      \zipper{\pointing{\selection_4}{\selection_5}}{\zframe'}
    }
  }{
    \performAction{
      ...
      \zipper{\restructuring{\selection_4}{\selection_2}{\selection_5}}{\zframe'}
    }
  } \\
  \inferrule[Delete]{
