\begin{figure*}
  ...
  \inferrule[Construct]{
    \fixHolesSelections{\selection_1}{\tile^s\selection_2}{\selection'_1}{\selection'_2}
  }{
    \performAction{
  ...
  \inferrule[MarkSelecting]{
    ...
    \fixHolesSelections{\selection_1}{\selection_3}{\selection'_1}{\selection'_3}
  }{
    \performAction{
  ...
  \inferrule[Delete]{
    \fixHolesSelections{\filterTiles{s}{\selection_1}}{\filterTiles{s}{\selection_3}}{\selection'_1}{\selection'_3}
  }{
    \performAction{
  ...
  \inferrule[MarkRestructuring]{
    ...
    \fixHolesSelections{\selection_1}{\selection_2\selection_3}{\selection_4}{\selection_5}
  }{
    \performAction{
      \zipper{\restructuring{\selection_1}{\selection_2}{\selection_3}}{\tfrelem^s}
    }{
