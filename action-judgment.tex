\begin{figure*}
  ...
  \inferrule[MoveRightEnter]{
    ...
    \performAction{
      ...
      \parseZipper{\zipper{\pointing{\selection_1\selem'}{\selection_3\selection_2}}{\zframe}}
    }
  }
  ...
  \inferrule[MoveRightExitTile]{
    \disassemblesUp{
      ...
      \zipper{\pointing{\selection_2}{\selem\selection_3}}{\zframe'}
    }
  }{
    \performAction{
      ...
      \parseZipper{
        \zipper{\pointing{\selection_2\selection_1\selem}{\selection_3}}{\zframe'}
      }
    }
  } \\

  \inferrule[ConstructAtomicTile]{
    \disassemblesDown{\tile^s}{\cdot} \\
  ...
  \inferrule[ConstructDisassemblingTile]{
    \disassemblesDown{\tile^s}{\selem\selection_3} \\
    \fixHolesSelections{\rtipconc{s}}{\selection_1\selem}{\selection_3\selection_2}{\ltipconc{s}}{\selection'_1}{\selection'_2}
  }{
    \performAction{
      \zipper{\pointing{\selection_1}{\selection_2}}{\tfrelem^s}
    }{
  ...
  \inferrule[SelectLeftDisassembles]{
    ...
    \performAction{
      ...
      \zipper{\selecting{\selection_1\selection_4}{\selection'_2}{\selection_3}}{\zframe}
    }
  }
  ...
  \inferrule[SelectLeftExit]{
    \disassemblesUp{
      ...
      \zipper{\pointing{\selection_3\selem}{\selection_4}}{\zframe'}
    }
  }{
    \performAction{
      ...
      \zipper{\selecting{\selection_3}{\selem\selection_1}{\selection_2\selection_4}}{\zframe'}
    }
  } \\

  \inferrule[SelectRightAtom]{
    \disassemblesDown{\selem}{\cdot} \\
    \parseZipper{\zipper{\pointing{\selection_1\selem}{\selection_3}}{\zframe}} =
  ...
  \inferrule[SelectRightDisassembles]{
    ...
    \performAction{
      ...
      \zipper{\selecting{\selection_1\selem'}{\selection_4\selection_2}{\selection_3}}{\zframe}
    }
  } \\
  ...
  \inferrule[MoveRightRestructuringWhole]{
    ...
    \performAction{
      \zipper{\pointing{\selection_1}{\selection_3}}{\tfrelem^s}
    }{
      \actionlit{move}\ \texttt{right}
    }{
      \zipper{\pointing{\selection'_1}{\selection'_3}}{\zframe}
